...
chrome_driver = webdriver.Chrome(executable_path ="C:\\Users\\MaxSa\\PycharmProjects\\DevOps-Course\\Lesson_4\\chromedriver_win32\\chromedriver.exe")
gecko_driver = webdriver.Firefox(executable_path ="C:\\Users\\MaxSa\\PycharmProjects\\DevOps-Course\\Lesson_4\\geckodriver-v0.30.0-win64\\geckodriver.exe")
...
executable_path="C:\\Users\\MaxSa\\PycharmProjects\\DevOps-Course\\Lesson_4\\geckodriver-v0.30.0-win64\\geckodriver.exe")
...
chrome_driver.find_element_by_xpath('//*[@id="yDmH0d"]/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[2]/div[2]/c-wiz[1]/span/span/div/textarea').send_keys("שלום")
...
chrome_driver.find_element_by_xpath('/html/body/ytd-app/div/div/ytd-masthead/div[3]/div[2]/ytd-searchbox/form/div/div[1]/input').send_keys('queen')
